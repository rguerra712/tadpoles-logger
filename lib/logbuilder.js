(function () {
    ...
    exports.createLogsFor = (childDetails, logs) => {
        ...
        let keyDecoded = `jfrogsquared-group-prodrServerDailyReport${message.subject_key}:${message.date}#BrightHorizonsFamilyCenteratOakHill`;
        let keyEncoded = new Buffer(keyDecoded).toString('base64');
        message.key = keyEncoded;
        return message;
    };
